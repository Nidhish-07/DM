...
if __name__ == "__main__":
    ...
    # Write association rules to an output CSV file
    output_file_path = "association_rules_output.csv"
    with open(output_file_path, 'w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(['Antecedent', 'Consequent', 'Confidence'])
    ...
    print(f"Association rules have been written to '{output_file_path}' CSV file.")